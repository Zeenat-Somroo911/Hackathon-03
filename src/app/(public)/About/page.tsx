...
export default function AboutUsSection() {
  return (
    <>
      ...
      <main className="flex flex-col lg:flex-row gap-8 p-5 lg:p-10">
        {/* Image Grid */}
        ...
        <section className="flex-1">
          <div className="max-w-[90%] lg:max-w-[70%] mx-auto">
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              Discover delicious flavors and exceptional dishes crafted with
              love and care. We believe food is more than sustenance; it's a
              celebration of life.
            </p>
            {/* Learn More Button */}
            <a
              href="/learn-more"
              className="flex items-center gap-2 bg-transparent text-black text-lg font-semibold hover:bg-gray-100 px-4 py-2 rounded-md"
      ...
      <section className="my-20 flex flex-col items-center px-5">
        ...
        <p className="w-full sm:w-2/3 lg:w-1/3 text-center text-gray-600">
          Discover why we're the best choice for your dining experience with
        ...
        <ul className="flex flex-col sm:flex-row flex-wrap justify-center gap-8 lg:gap-12 w-full">
          ...
          <li
            key="feature-1"
            className="text-center flex flex-col items-center w-full sm:w-1/2 lg:w-1/4 px-4"
          >
            <Image
            ...
            <p className="text-gray-600">
              Our chefs are world-class, bringing passion and creativity to
              every dish.
            </p>
          </li>
          ...
          >
            ...
            <p className="text-gray-600">
              With over 120 options, you'll find something to delight your
              palate.
            </p>
          </li>
          ...
          >
            ...
            <p className="text-gray-600">
              Enjoy dining in a clean, comfortable, and welcoming atmosphere.
            </p>
          </li>
        </ul>
      </section>
