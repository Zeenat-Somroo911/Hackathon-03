      ...
      <div className="relative container mx-auto flex flex-col lg:flex-row items-center justify-between py-16 px-6 md:px-12 lg:px-28">
        ...
        <div className="flex flex-col items-start lg:w-6/12 z-10">
          <span className="text-orange-500 font-semibold text-lg mb-2">
            Its Quick & traditional
          </span>
          <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-4">
            <span className="text-orange-500">The</span> Art of speed food Quality
          </h1>
          <p className="text-gray-300 mb-6 leading-relaxed">
          "Food is not just sustenance; it is an experience of flavors, cultures, and traditions. Every dish tells a story, from the farm to the table, blending ingredients with care to create something delightful. It brings people together, celebrating the joys of life with every bite."
          </p>
          <Link
            href="/menu"
